...
input_file = "D:/sem 5/Mini Project/Prediction-and-Optimization-of-Smart-Dish-Specific-Demand-in-Restaurants-using-Machine-Learning/data/train.csv"
output_file = "D:/sem 5/Mini Project/Prediction-and-Optimization-of-Smart-Dish-Specific-Demand-in-Restaurants-using-Machine-Learning/data/train_replicated_with_dates.csv"
...
def replicate_and_add_dates(input_path, output_path, target_rows):
    ...
    end_date = "2024-11-30"  # One day before 31-Dec-2024
